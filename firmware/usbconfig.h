 ...
 */
#define USB_RESET_HOOK(resetStarts)     if(!resetStarts){extern void hadUsbReset(void); hadUsbReset();}
 ...
 */
#define USB_CFG_VENDOR_NAME     'r', 'e', 'd', 'f', 'e', 'l', 'i', 'n', 'e', 'n', 'i', 'n', 'j', 'a', '.', 'o', 'r', 'g', '.', 'u', 'k'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'R', 'F', 'T', 'h', 'e', 'r', 'm', 'o', 'm', 'e', 't', 'e', 'r'
